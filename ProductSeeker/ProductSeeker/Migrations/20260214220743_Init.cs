        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MergedIntoProductCoreId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCore_ProductCore_MergedIntoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    State = table.Column<int>(type: "int", nullable: false),
                    MergedIntoProductSpecId = table.Column<int>(type: "int", nullable: true),
                    MergedIntoId = table.Column<int>(type: "int", nullable: true),
                    ProductCoreId = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSpecs_ProductSpecs_MergedIntoId",
                        column: x => x.MergedIntoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecCrationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    IdCreator = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCore_MergedIntoId",
                table: "ProductCore",
                column: "MergedIntoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSpecs_MergedIntoId",
                table: "ProductSpecs",
                column: "MergedIntoId");
